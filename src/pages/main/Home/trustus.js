...
const TrustUs = () => {
  return (
    <div className="bg-white dark:bg-gray-800 py-10 flex flex-col items-center justify-center mt-20 md:mb-20 overflow-hidden">
      ...
      <div className="bg-gray-100 xs:bg-transparent sm:bg-transparent w-full overflow-hidden flex md:flex-row sm:flex-col xs:flex-col items-center justify-center gap-16 h-48 md:h-auto sm:h-auto xs:h-auto">
