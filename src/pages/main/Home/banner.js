...
function Banner() {
  return (
    <div className="relative mx-2 lg:mx-2 md:mx-4 sm:mx-0 xs:mx-0 h-100 lg:mb-10 lg:mt-10 lg:h-auto md:h-auto sm:h-auto xs:h-auto mb-5 flex flex-row md:flex-row sm:flex-col xs:flex-col-reverse items-center justify-center  overflow-hidden p-5  md:gap-2">
      ...
      <div className="relative z-10 ">
        <div className="">
          ...
          Transforming Operations Data Into Actionable{" "}
            <span className="relative inline-block" style={{ minWidth: "200px", maxWidth: "200px", whiteSpace: "nowrap"}}>
      ...
      <div className="relative z-10">
        <img src={IllustrationLight} alt="Mockup" className="w-220 lg:w-220 md:w-220 sm:w-200 xs:w-full pr-2 xs:pr-0 xs-w-full sm:mt-10 xs:mb-10 rounded-3xl lg:rounded-3xl md:rounded-t-[60px] md:rounded-b-[20px] sm:rounded-none xs:rounded-none" />
      </div>
    </div>
  );
}
